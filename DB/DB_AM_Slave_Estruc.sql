...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_calificaciones_finales';
...
CREATE TABLE `am_campus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_campus';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_cursos';
...
CREATE TABLE `am_estados` (
  ...
  KEY `estado` (`estado`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_estados';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_facultades';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_genero';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_interfaz';
...
CREATE TABLE `am_notificaciones` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_notificaciones';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_numero_campus';
...
CREATE TABLE `am_per_aca` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_per_aca';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_programa';
...
CREATE TABLE `am_tipo_curso` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_tipo_curso';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_usuario';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://USER:PASS@HOST:PORT/DATABASE/am_usuario_curso';
