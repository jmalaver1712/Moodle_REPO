...
$noticias = $interfaz->data_notificaciones();
				...
				<div id="noticias" class="oculto" style="<?= $style_not; ?>">
					<div class="row">
						<div class="col s12">
							...
							<a  class="fecha_not" href="<?= URL_CAMPUS ?>/pages/noticias.php" target="_blank"><h3>Ver Noticias Campus</h3></a>
						</div>
					</div>
				</div>
				<!-- FIN NOTIFICACIONES -->
